<template>
  <footer border="t base" py-6>
    <div class="max-w-6xl mx-auto px-4" flex="~ col md:row gap3" items-center justify-between>
      <div text="sm gray6" flex="~ wrap gap2" items-center justify-center md:justify-start>
